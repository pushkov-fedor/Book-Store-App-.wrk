...
function ShoppingCartItem(props) {
    ...
    return (
            <div className="w-100 row py-3 mx-0 position-relative shopping-cart-item-container">
                <div className="col-12 col-sm-4 col-md-3 text-center"><img className="w-75 b shopping-cart-item-book-cover" src={`${URL}static/${props.cover}`} alt="..."/></div>
                ...
                <div className="col-12 col-sm-12 col-md-3 py-3 px-sm-0 px-4 d-flex align-items-center justify-content-center">
                    <div className="row shopping-cart-items-buttons">
                        ...
                        <div className="col-4 d-flex justify-content-center align-items-center text-dark shopping-cart-item-count">{Number(props.isStillInCart)}</div>
                        <div className="col-4 d-flex justify-content-center align-items-center shopping-cart-item-add-button" onClick={addToCart}>
