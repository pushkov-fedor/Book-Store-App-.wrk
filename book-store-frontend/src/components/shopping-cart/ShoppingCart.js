  ...
  observer(props => {
    ...
    const savedBooksElement = booksInCart.map(book => (
      <ShoppingCartItem
        ...
        author={book.author}
        price={book.price}
        isStillInCart={book.isStillInCart}
    ...
    const summaryPrice = booksInCart
      ...
      <div className="row my-5 position-relative">
        <div className="col-12 col-xl-8">
          ...
          <div className="d-flex justify-content-between">
            <h2
              className={`${
                savedBooksElement.length === 0 ? "d-none" : ""
              } mt-4 shopping-cart-cost`}
            >
              Total cost:
            </h2>
            <h2
        ...
        <div
          className={`col-12 col-xl-4 row ${
            savedBooksElement.length === 0 ? "d-none" : "d-flex"
        ...
        <div className="d-flex flex-column justify-content-center align-items-center w-100">
          <img
            className={`${
              savedBooksElement.length === 0 ? "d-block" : "d-none"
            } w-75`}
            src="https://cdn.dribbble.com/users/1527146/screenshots/5091984/___-2.jpg"
