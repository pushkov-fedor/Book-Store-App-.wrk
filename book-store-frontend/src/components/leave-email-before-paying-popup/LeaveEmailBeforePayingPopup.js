    ...
    return (
      <div className="">
        <div className="position-fixed d-flex justify-content-center align-items-center leave-email-before-paying-popup-container"
          ...
          <div className="m-3 leave-email-before-paying-popup-subcontainer m-sm-5">
              <div className="m-0 bg-white p-5 mx-sm-5 leave-email-before-paying-popup-subsubcontainer">
