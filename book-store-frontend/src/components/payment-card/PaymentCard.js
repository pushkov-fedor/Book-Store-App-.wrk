...
const PaymentCard = inject("rootStore")(
  observer(props => {
    ...
    return (
      <div className="p-4 w-100 mt-5 mt-xl-0 payment-card-container">
        <h2 className="text-white payment-card-card-details-header">
          Card Details
        </h2>
        <div className="ml-4 mt-4 shadow text-white p-4 d-none d-sm-block payment-card-view-container">
          <h3>Bank Card</h3>
          <h4 className="mt-4 mb-4">
            {cardNumber.get() === "" ? "XXXX XXXX XXXX XXXX" : cardNumber.get()}
          </h4>
          <div className="position-relative">
            <div>
              ...
              <h5
                style={{
                  opacity: "0.8",
                  visibility: nameOnCard.get() === "" ? "hidden" : "visible"
                }}
              >
            ...
            <img
              className="position-absolute h-100 payment-card-view-mastercard-logo"
        ...
        <form className="mt-4" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              className="form-control text-white border-0 payment-card-input"
              id="nameOnCard"
              value={nameOnCard.get()}
          ...
          <div className="form-group">
            ...
            <InputMask
              id="cardNumber"
              className="form-control text-center text-white border-0 payment-card-input"
              value={cardNumber.get()}
          ...
          <div className="row">
            <div className="col-12 col-sm-9 form-group pr-0">
              ...
              <div className="row w-100 mx-0">
                <select
                  className="col-7 custom-select text-white border-0 mr-1 payment-card-input"
                  value={expirationMonth.get()}
                ...
                <select
                  className="col-4 custom-select text-white border-0 ml-1 payment-card-input"
                  value={expirationYear.get()}
            ...
            <div className="col-12 col-sm-3 form-group">
              ...
              <InputMask
                id="cvv"
                className="form-control text-center text-white border-0 px-1 payment-card-input"
                value={cvv.get()}
