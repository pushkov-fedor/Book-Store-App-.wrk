...
const EditBook = inject("rootStore")(observer((props) => {
  ...
  const dismissShowAddBookPopup = props.rootStore.adminStore.dismissShowAddBookPopup;
  ...
  return (
    <div id="add-book-bg" className="position-fixed d-flex flex-column justify-content-center align-items-center
    add-book-bg"
        ...
        <div className="row">
          ...
          <div className="col-sm-6 col-12 d-flex flex-column align-items-center">
            <img className="edit-book-cover"
                 src={`${URL}static/${addBook.get().cover_path}`}/>
